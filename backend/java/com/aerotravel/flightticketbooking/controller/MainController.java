...
public class MainController {
    ...
    public String showAddAirportPage(Model model) {
        ...
        return "newAirport";//WEB-INF/tamplet/newAriport.hmtl
    }

    @PostMapping("/airport/new")//BindingResult need to comes right after the form is being validated
    //likewise model parameter needs to come after BindingResult
    public String saveAirport(@Valid @ModelAttribute("airport") Airport airport, BindingResult bindingResult, Model model) {
        if (bindingResult.hasErrors()) {
            ...
            model.addAttribute("airport", new Airport());
            return "newAirport";//if error redirect to the same page(newAirport)
        }
